...
const RegisterComp = () => {
    const [formData, setFormData] = useState({
        ...
        role: '',
        contactDetails: '',
        subjectSpecialization: '' // New field for teachers
    });
    ...
    const validate = () => {
        ...
        // Validate subject specialization only if the role is Teacher
        if (formData.role === 'Teacher' && !formData.subjectSpecialization.trim()) {
        ...
        <div className='min-vh-100 d-flex align-items-center justify-content-center' style={{ backgroundColor: "#FFF8E1" }}>
            <div className="shadow-lg p-4" style={{ backgroundColor: "white" }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {/* Conditionally show subject specialization input for teachers */}
                    {formData.role === "Teacher" && (
                        <div className="mb-3">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className={`form-control ${errors.subjectSpecialization ? 'is-invalid' : ''}`}
                                placeholder="Enter your subject specialization"
                            />
                            {errors.subjectSpecialization && <div className="invalid-feedback">{errors.subjectSpecialization}</div>}
                        </div>
                    )}
                    ...
                    <div className="text-center mt-3 LoginRegisterText">
                        <p>Already have an account? 
                            <a href="Login" className='RegisterLogin'> Logins here</a>
                        </p>
                    </div>
                </form>
            </div>
